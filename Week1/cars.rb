class CarDealer
	...
	def add_car(brand, model)
		@inventory[brand.capitalize.to_sym] ||= []		# ||= means "or or equals". sino existe el coche crea un nuevo arra para el. si existe, no lo toca
	...
	def print_inventory
		@inventory.each do |k,v|
			print k.to_s + ": "
			puts v.join(", ")	# .join convierte cada elemento del array 
		end	
	end		
end		
